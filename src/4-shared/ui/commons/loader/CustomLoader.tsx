  ...
  return (
    <div className="fixed inset-0 flex flex-col items-center justify-center bg-gray-50 z-50">
      <div className="relative flex items-center justify-center">
        {/* Outer Ring */}
        <div className="w-16 h-16 border-4 border-gray-200 border-t-[#6ABDA6] rounded-full animate-spin"></div>

        {/* Inner Pulse Dot */}
        <div className="absolute w-4 h-4 bg-[#6ABDA6] rounded-full animate-pulse"></div>
      </div>
