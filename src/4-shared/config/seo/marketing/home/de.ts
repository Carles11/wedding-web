...
export const seoMetadata: SitewideSEO = {
  marketing: {
    ...
    description:
      "Erstelle deine mehrsprachige Hochzeitswebsite fur immer mit nativem RTL, eigener Domain und starkem Datenschutz. Starte gratis in 11 Sprachen mit WeddWeb.",
