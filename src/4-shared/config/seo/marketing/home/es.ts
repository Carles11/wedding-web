...
export const seoMetadata: SitewideSEO = {
  marketing: {
    ...
    keywords: [
      "sitio web de boda",
      "creador de sitios de boda",
      "RSVP boda",
      "sitio de boda multilingüe",
      "sitio de boda gratis",
      "sitio de evento",
      "galería de fotos boda",
      "dominio personalizado boda",
      "sitio de boda móvil",
      "mejor sitio web de boda",
      "plantillas sitio de boda",
      "sitio de boda para invitados",
      "opiniones sitio de boda",
      "sitio de boda fácil",
      "sitio de boda privado",
      "sitio de boda seguro",
      "cómo crear un sitio de boda",
      "cuál es el mejor sitio de boda",
      "weddweb",
      "reseñas weddweb",
    ],
