          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span className="rounded-full bg-slate-100 px-2 py-0.5 text-[10px] uppercase font-bold tracking-wider text-slate-600">
                  {eventCountLabel}
                </span>
                <span
              ...
              <div className="mt-3">
                <ul className="space-y-3">
                  {visibleEvents.map((event) => (
                    <li
                      key={event.id}
                      className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-t border-gray-50 pt-3 first:border-0 first:pt-0"
                    >
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-1 flex flex-wrap items-center gap-2">
                          ...
                          {event.time && (
                            <span className="text-[11px] text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded border border-emerald-100 font-medium">
