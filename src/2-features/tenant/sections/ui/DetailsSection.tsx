        ...
        {grouped.map(
          (day) =>
            day.events.length > 0 && (
              <div
                key={day.slug}
                className="bg-neutral-50 dark:bg-neutral-800 rounded-lg p-4 md:p-6 border border-neutral-100 dark:border-neutral-700 flex flex-col gap-4"
              >
                <div className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  {day.displayDate && (
                    <div className="text-sm font-medium text-neutral-500 dark:text-neutral-400 sm:text-right">
                      {day.displayDate}
                    </div>
                  )}
                </div>
                    ...
                    return (
                      ...
                      >
                        <div className="w-24 text-sm   text-neutral-600 dark:text-neutral-400">
                          ...
                          {compactDate && (
                            <div className="mt-0.5 text-xs font-semibold text-neutral-500 dark:text-neutral-400">
                              {compactDate}
                            </div>
                          )}
                        </div>
