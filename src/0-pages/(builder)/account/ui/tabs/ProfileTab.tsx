...
import { useParams } from "next/navigation"; // 1. Add this import
...
export function ProfileTab({
  ...
  const currentLang =
    typeof rawParams?.lang === "string" && isValidLanguage(rawParams.lang)
      ? rawParams.lang
      : "en";
  ...
  return (
    <>
      ...
      <StepLayout
        ...
        nextLabel={nextLabel}
        backLabel={backLabel}
        showActions={Boolean(onNext || onBack)}
        translations={translations}
        fullHeight={false}
      >
                    ...
                    <div className="mt-3 space-y-2 animate-in fade-in slide-in-from-top-1">
                      ...
                      <div className="relative">
                        ...
                        <button
                          ...
                          className="absolute right-3 top-1/2 -translate-y-1/2 text-(--builder-color-text-muted) hover:text-(--builder-color-text) focus:outline-none"
                        >
